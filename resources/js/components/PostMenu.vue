      ...
      <ul class="header__navbar">
        <li class="header__item">
          <a href="#" class="header__link">
            <transition >
              ...
              <button class="header--button" v-if="show" key="on" @click="show = false">
               ...
               <svg viewBox="0 0 24 24" width="1em" height="1em" class="header--icon"><g fill-rule="evenodd" transform="translate(-446 -350)"><path d="M458 360a2 2 0 1 1-4 0 2 2 0 0 1 4 0m6 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0m-12 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0"></path></g>   <title>Close</title></svg>

              </button>
              <button class="header--button" v-else key="off" @click="show = true">
                 <svg viewBox="0 0 24 24" width="1em" height="1em" class="header--icon"><g fill-rule="evenodd" transform="translate(-446 -350)"><path d="M458 360a2 2 0 1 1-4 0 2 2 0 0 1 4 0m6 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0m-12 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0"></path></g>  <title>Navigation Menu</title></svg>
          ...
          <transition name="dropdown">
            <div class="dropdown__menu__post shadow-md" v-bind:class="{ active: show }" v-if="show">
              <ul class="dropdown__menu__post-nav">
                <li class="dropdown__menu__post-item">
                  <a href="#" class="dropdown__menu__post-link" title="Account">
                    <div class=" flex dropdown__menu__post-action">
                        <div class="dropdown__menu__post-svg">
                        ...
                        <div class="dropdown__menu__post-text">Edit post</div>
                    </div>
                ...
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu__post-link" title="Help">
                    <div class="flex dropdown__menu__post-action">
                      <div class="dropdown__menu__post-svg">
                    ...
                    <div class="dropdown__menu__post-text"> <button  @click="
                              $store.dispatch('deletePost',post.data.post_id)">Delete post</button>
                    </div>
                    </div>
