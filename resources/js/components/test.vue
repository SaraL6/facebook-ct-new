                    ...
                    <div class="relative px-2 flex-auto">
                        <div class="bg-white roundedw-2/3overflow-hidden">
                            ...
                            >
                                 ...
                                 <cld-image v-if="imgExists" :public-id="post.data.attributes.image"   responsive="width"   class="w-full rounded border-2 border-gray-300" >
...
export default {
    ...
    mounted() {
        ...
        editUploadImg(){
            // this.mypath=this.imgPath.split('/');           
            // this.imgPath=this.mypath[2];
                ...
                var myEditWidget = cloudinary.createUploadWidget({
                        ...
                        cropping: true,
                        multiple: false,
                        public_id:this.imgPath,
                        folder: 'fb-clone/userPosts',
                    }, (error, result) => { 
                     
                        if (!error && result && result.event === "success") {        
                                    //this.imgExists= result.info.public_id; 
